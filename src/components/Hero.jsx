  ...
  return (
    <section className="relative px-5 pt-24 pb-16 flex flex-col items-center text-center overflow-hidden map-grid">
      ...
      <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center gap-6">
        ...
        <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-[#1E293B] border border-[#334155] shadow-lg transition-all duration-300 hover:border-[#0EA5E9]/50 hover:shadow-[0_0_20px_rgba(14,165,233,0.25)]">
          <img 
            src={welcomeWholeBody} 
            alt="RideOut Mascot Welcome" 
            className="w-10 h-10 object-contain drop-shadow-[0_0_10px_rgba(14,165,233,0.5)]"
          />
          <span className="text-xs font-extrabold text-[#89CEFF] uppercase tracking-wider">
            Ride Master Pack Tracking Active
          </span>
        </div>
      ...
      {/* Hero Smartphone Mockup Container (Glows on Hover) */}
      <div className="mt-16 relative w-full max-w-[340px] md:max-w-[400px] mx-auto z-10 group">
